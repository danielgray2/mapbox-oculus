...
public class LatLonMenuView : IAbsMenuView
{
    [SerializeField]
    GameObject latDDGo;
    ...
    private void Start()
    {
        Setup(MenuEnum.DEP_LAT_LON, menuHandlerGo.GetComponent<MenuView>());
    }
    ...
    public void PrepForTransition()
    {
        ...
        mV.AddTransfToUse(new LatLonTransf(latName, lonName, selectedMap));
